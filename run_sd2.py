...
import torch
import argparse 
from ndm.pipeline_sd2 import StableDiffusionNdmPipeline
from ndm.pipeline_detect2 import StableDiffusionDetectPipeline
import pandas as pd
...
SD21_VERSION    = "/data/sharehub/stable-diffusion-2-1"
save_dir     = "results_sd2"
os.makedirs('{:s}'.format(save_dir), exist_ok=True)

pipe = StableDiffusionNdmPipeline.from_pretrained(SD21_VERSION, torch_dtype=torch.float16).to("cuda")
pipe.unet.enable_gradient_checkpointing()
pipe.enable_attention_slicing()
pipe1 = StableDiffusionDetectPipeline.from_pretrained(SD21_VERSION).to("cuda")
